      ...
      data.forEach(function (row, rowIndex) {
        ...
        row.forEach(function (cell, cellIndex) {
          ...
          if (sizingColumns[sizeIndex].showAsLink === true && cell.value.trim() !== '') {
            cell.value = "\n            <a href=\"".concat(encodeURI(cell.value.replace(/'/g, '%27')), "\" target='").concat(sizingColumns[sizeIndex].openInNewTab === true ? '_blank' : '_self', "'>").concat(cell.displayText || sizingColumns[sizeIndex].linkText || cell.value, "</a>\n          ");
          }
